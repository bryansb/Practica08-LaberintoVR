...
public class Key : MonoBehaviour {
	...
	void Update () {
        ...
        key.transform.Rotate(0, Time.deltaTime * 180, 0, Space.World);
    }
	...
	public void OnKeyClicked () {
        ...
        GameObject clonKeyPoof = (GameObject)Object.Instantiate(keyPoofPrefab, key.transform);
        Object.Destroy(key, 0.8f);
    }
}
