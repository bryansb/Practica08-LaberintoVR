...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        //Debug.Log(leftDoorStartRotation);
        // Use 'leftDoorStartRotation' and Quaternion.Euler() to set the end rotation of the 'Left_Door' game object and assign it to 'leftDoorEndRotation'
            //leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(-90, 0, 0);
            //leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(0, -90, 0); 
        ...
        // Use 'rightDoorStartRotation' and Quaternion.Euler() to set the end rotation of the 'Right_Door' game object and assign it to 'rightDoorEndRotation'
            //rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(-90, 0, 0);
            //rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(0, -90, 0);
    ...
    public void OnDoorClicked() {
        ...
        if (locked == false) {
            ...
            foreach (var collider in door.GetComponentsInChildren<BoxCollider>()){
            ...
            AudioSource.PlayClipAtPoint(lockedAudio, door.transform.position);
        }
	}
