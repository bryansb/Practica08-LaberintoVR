...
public class Coin : MonoBehaviour {
    ...
    void Update () {
        ...
        coin.transform.Rotate(0, Time.deltaTime * 180, 0, Space.World);
	}
	...
	public void OnCoinClicked () {
        ...
        GameObject clonCoinPoof = (GameObject) Object.Instantiate(coinPoofPrefab, coin.transform);
        Object.Destroy(coin, 0.8f);
    }
}
